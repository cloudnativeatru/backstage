...
2. Implementar pipeline de CI a aplicación backend (10 min)
...
6. Consumir template de workflow CI (3 min)
7. Crear skeleton en backstage y disponibilizarlo como template junto al workflow CI (20 min)
